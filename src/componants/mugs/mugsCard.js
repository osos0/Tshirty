...
// import Mugs from "../../dataB/mugs/MugsDataBase"; // Import the Mugs data
...
//                   <img src={Mugs.img} className="" alt="Mugs" />
//                 </div>
//                 <div className="card-body">
//                   <h4 className="card-title">{Mugs.desc}</h4>
//                   <h5 className="card-title">{Mugs.price} LE</h5>
